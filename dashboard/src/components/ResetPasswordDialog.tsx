...
import { resetTechnicianPassword, ApiError } from "@/services/api";
...
export default function ResetPasswordDialog({ open, technicianId, technicianName, onClose }: ResetPasswordDialogProps) {
  ...
  async function submit(event: FormEvent<HTMLFormElement>): Promise<void> {
    ...
    try {
      ...
      setError(err instanceof ApiError ? err.message : "Password could not be reset");
    } finally {
      setIsSaving(false);
    }
  }

...
- Newspaper metaphor: high-level functions at the top of the file, details on demand
...
- Special Case / Null Object pattern: return an object with default behavior instead of null checks
...
- [*"Clean Architecture: A Craftsman's Guide to Software Structure and Design"*](https://www.amazon.com/Clean-Architecture-Craftsmans-Software-Structure-Design/dp/0134494164?tag=wondelai00-20) by Robert C. Martin
